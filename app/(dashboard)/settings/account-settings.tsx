        ...
        <div>
          <div className="flex items-center gap-4">
            <button
              ...
              className="relative h-20 w-20 shrink-0 overflow-hidden rounded-full border border-white/10 bg-brand/20"
            >
              {image ? (
            ...
            />
            <p className="text-xs text-white/40">프로필 사진을 눌러 변경할 수 있습니다.</p>
          </div>
