  ...
  return (
    <section className="rounded-2xl border border-[var(--card-border)] bg-[var(--card-bg)] p-5">
      <div className="mb-4">
        ...
        <p className="mt-1 text-xs text-white/40">프로필 사진과 비밀번호를 이 화면에서 관리합니다.</p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[220px_minmax(0,1fr)]">
        <div className="flex flex-col items-center gap-3">
          <button
            ...
            className="relative h-28 w-28 overflow-hidden rounded-full border border-white/10 bg-brand/20"
          >
            {image ? (
            ...
            <span className="absolute inset-x-0 bottom-0 flex items-center justify-center gap-1 bg-black/55 py-1.5 text-[11px] font-semibold text-white">
          ...
          />
          <p className="text-center text-[11px] text-white/35">정사각형 사진을 권장합니다.</p>
        </div>
      ...
      <div className="mt-6 border-t border-white/8 pt-5">
        ...
        <div className="grid gap-3 md:grid-cols-3">
          <input
            ...
            placeholder="현재 비밀번호"
            className="rounded-xl border border-white/10 bg-black/30 px-3 py-2.5 text-sm text-white outline-none placeholder:text-white/30 focus:border-gold"
          />
          <input
            type="password"
            value={newPassword}
        ...
        <button
          ...
          className="mt-3 rounded-xl bg-white/8 px-4 py-2 text-sm font-semibold text-white hover:bg-white/12 disabled:opacity-50"
        >
